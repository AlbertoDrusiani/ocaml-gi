...
let parseObject o =
    print_endline("pppppppppppp OBJECT ppppppppppp");
    let l_interfaces = ref [] in
    print_endline("-------------INIZIO FOR INTERFACCE------------");
    ...
    print_endline("-------------INIZIO FOR METODI------------");
    ...
    print_endline("-------------INIZIO FOR PROPRIETÀ------------");
